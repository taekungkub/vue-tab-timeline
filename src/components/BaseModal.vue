            ...
            <slot name="footer">
              <div class="with-confirm">
                <div class="text-right mt-4">
                  <button @click="close" class="px-4 py-2 text-sm text-gray-600 focus:outline-none hover:underline mr-2">Cancel</button>
                  <button @click="emit('onConfirm')" class="mr-2 px-4 py-2 text-sm rounded text-white bg-indigo-600 focus:outline-none hover:bg-indigo-500">
                    Confirm
                  </button>
                </div>
              </div>
...
.with-confirm {
  @apply flex items-center justify-end flex-nowrap;
}
